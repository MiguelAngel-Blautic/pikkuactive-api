from .tbl_user import tbl_user, tbl_rol
from .tbl_entrena import tbl_entrena
from .tbl_planes import tbl_planes
from .tbl_entrenamientos import tbl_entrenamientos
