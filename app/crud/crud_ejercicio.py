...
from app.schemas import PlanCreate, PlanUpdate, EjercicioCreate, EjercicioUpdate, Plan
...
class CRUDEjercicio(CRUDBase[tbl_ejercicio, EjercicioCreate, EjercicioUpdate]):
    ...
    def get_multi_by_rol(
        ...
        if rol == 3:
            res = db.query(tbl_ejercicio).outerjoin(tbl_planes, tbl_planes.id == tbl_ejercicio.fkPlan).outerjoin(tbl_entrena, tbl_planes.fkCreador == tbl_entrena.fkUsuario). \
