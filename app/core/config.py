...
class Settings(BaseSettings):
    ...
    SQLALCHEMY_DATABASE_URI: Optional[str] = 'mariadb+mariadbconnector://root:localhost@82.223.121.8:3306/mm'  # Optional[PostgresDsn] = None
